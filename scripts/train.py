...
# --- FlowFromDirectory n'est pas utilisé ici car les images sont dans un format .mat ---
...
print(f"Nombre d'images et de classes trouvées pour l'entraînement : {train_gen.samples}, {train_gen.num_classes}")
